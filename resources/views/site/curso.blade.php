...
<body id="cursoDetalhes">
  ...
  <section class="container-fluid s_cursoVideo">
    <div class="container-fav">
      <div class="_text">
        <h4>É um fato conhecido de todos que um leitor.</h4>
        <p>
    ...
    <div class="container-fav">
      ...
      <main>
        <div class="_modulos">
          <div class="_box">
            <div class="_main">
              <span>Módulo - Conceitos básicos</span>
              <div class="_icon">
        ...
        <div class="_info">
          ...
          <h4>Paulo Guerra</h4>
          <p> A vantagem de usar Lorem Ipsum é que ele tem uma distribuição normal de letras, ao contrário de "Conteúdo aqui, conteúdo aqui", fazendo com que ele tenha uma aparência similar a de um
            texto legível.</p>
