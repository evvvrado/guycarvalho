...
<body id="clinica">
  ...
  <section class="container-fluid s_eventoVideo">
    <div class="container-fav">
      ...
      <div class="_video">
        <iframe style="height: 385px; width: 100%; max-width: 595px" src="{!! \App\Classes\Util::convertYoutube($evento->video) !!}?autoplay=1" title="YouTube video player" frameborder="0"
