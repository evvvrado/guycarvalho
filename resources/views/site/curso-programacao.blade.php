...
<body class="cursos curso-detalhes" style="overflow:hidden;">
    ...
    <main class="main">
        <section class="container-fluid s_detail">
            ...
            <div class="container-fav">
                <div class="_intro">
                    <p style="text-align: center;max-width:  650px;color: var(--corVinho2); font-size: 18px!important; margin-bottom: 35px;">Programação da introdução ao Mundo do Vinho, porta de entrada nesse fascinante
                        universo, é um curso abrangente e completo, desenvolvido pelos 
                       especialistas da ABS-Brasil.</p>
                </div>
                ...
                <div class="_text">
                    <ul>
                        <li>Introdução</li>
                        <li>História do vinho varietais e cortes</li>
                        <li>Técnicas de degustação</li>
                        <li>Viticultura</li>
                        <li>Uvas viníferas</li>
                        <li>Vinificação brancos, rosés e tintos 1</li>
                        <li>Vinificação brancos, rosés e tintos 2</li>
                        <li>Vinificação brancos, rosés e tintos 3</li>
                        <li>Técnicas Especiais - Vinhos doces</li>
                        <li>Técnicas Especiais - Vinhos do Porto e da Madeira</li>
                        <li>Abertura de garrafas (Serviço)</li>
                        <li>Vinho e Saúde: Fatores na decisão de compra</li>
                        <li>Adegas, rolhas, garrafas e rótulos</li>
                        <li>Terroir: conceito e influência no vinho</li>
                        <li>Ações do amadurecimento </li>
                    </ul>
