                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="titulo" name="titulo" type="text" class="form-control" placeholder="Insira o titulo">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="textarea" name="sobre" class="form-control" maxlength="107" rows="3" placeholder="Descrição breve sobre o curso" required></textarea>
                            </div>
