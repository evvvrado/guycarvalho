        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('painel.patrocinadores.salvar') }}" method="POST"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="productname" name="nome" type="text" class="form-control"
                                        placeholder="Insira o nome" value="{{$patrocinador->nome}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="url" type="url" placeholder="Insira a URL"
                                        id="example-url-input" value="{{$patrocinador->url}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            <div class="row">
                                <div class="col-12 text-center d-flex align-items-center justify-content-center">
                                    <picture
                                        style="height: 80px; background-color:#f3f4f6; width: 100%; max-width: 400px; overflow: hidden; display: flex; align-items:center; justify-content: center;">
