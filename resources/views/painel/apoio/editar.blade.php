...
@section('titulo')
    Publicidade / <a style="color: unset" href="{{ route('painel.apoio') }}">Apoio</a> / Editar
@endsection
...
@section('conteudo')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Editar Apoiador</h4>
                    <form action="{{ route('painel.apoio.salvar') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="apoio_id" value="{{ $apoio->id }}">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label for="productname">Nome</label>
                                    <input id="productname" name="nome" type="text" class="form-control"
                                        placeholder="Insira o nome" value="{{ $apoio->nome }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="url" type="url" placeholder="Insira a URL"
                                        id="example-url-input" value="{{ $apoio->url }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 text-center d-flex align-items-center justify-content-center">
                                    <picture
                                        ...
                                        <img id="banner-preview" @if(!$apoio->foto) src="{{ asset('admin/images/thumb-padrao.png') }}" @else src="{{asset($apoio->foto)}}"  @endif
                                            style="width: 100%;" alt="">
                                    </picture>
                                </div>
                            </div>
