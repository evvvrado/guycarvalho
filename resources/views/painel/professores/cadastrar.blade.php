                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="atuacaoprofessor" name="atuacaoprofessor" type="text" class="form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="empresaprofessor" name="empresaprofessor" type="text" class="form-control"
                                        placeholder="Insira o nome">
                                </div>
                            </div>
                        </div>
