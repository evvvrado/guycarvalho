                ...
                <form id="form-cadastro" action="{{ route('painel.artigo.cadastrar') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="titulo" name="titulo" type="text" placeholder="Insira o título do artigo" class="form-control" value="{{$noticia->titulo}}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="fonte" name="fonte" type="text" placeholder="Fonte do artigo" class="form-control" value="{{$noticia->fonte}}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <input id="resumo" name="resumo" type="text" placeholder="Resumo do Artigo" class="form-control" value="{{$noticia->resumo}}">
                        </div>
                    </div>
                    <div class="row">
