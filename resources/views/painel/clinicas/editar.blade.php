        ...
        <div class="col-12">
                    ...
                    <form action="{{ route('painel.clinicas.salvar') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row flex-row align-items-center justify-content-center">
                            ...
                            <div class="col-8 mt-3">
                                <div class="row">
                                    <div
                                        class="col-8 text-center d-flex align-items-center justify-content-center  flex-column">
                                        Banner
                                        <picture
                                            ...
                                            <img id="banner-preview" @if (!$evento->banner) src="{{ asset('admin/images/thumb-padrao.png') }}" @else src="{{ asset($evento->banner) }}" @endif style="height: 100%;" alt="">
                                        </picture>
                                    </div>
                                </div>
                                <div class="row mt-3">
            ...
            <div class="card embaixadores">
                <div class="card-body">
                    ...
                    <form action="{{ route('painel.clinicas.participante.adicionar', ['evento' => $evento]) }}"
