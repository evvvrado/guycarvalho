    ...
    <div class="col-12">
                                    ...
                                    <td>
                                        <div class="btn-group edit-table-button ">
                                            <button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="height: 34px!important;"><i
                                                    class="bx bx-edit"></i></button>
                                            <div class="dropdown-menu" style="margin: 0px;">
                                                <a class="dropdown-item" href="{{ route('painel.clinicas.pacote.deletar', ['pacote' => $pacote]) }}" style="color: red" href="#">Excluir</a>
                                            </div>
                                        </div>
        ...
        <div class="card hoteis">
            <div class="card-body">
                ...
                <form action="{{ route('painel.clinicas.hotel.adicionar', ['evento' => $evento]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="col-sm-12">
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable_info"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 35%;" aria-sort="ascending"
                                        aria-label="Name: activate to sort column descending">Nome</th>
                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 35%;" aria-label="Position: activate to sort column ascending">
                                        Função
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 15%;" aria-label="Start date: activate to sort column ascending">
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="display: flex; align-items: center; justify-content:center;"><img src="{{ asset($participante->foto) }}" style="width: 100px;" alt="">
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group edit-table-button ">
                                            <button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="height: 34px!important;"><i
                                                    class="bx bx-edit"></i></button>
                                            <div class="dropdown-menu" style="margin: 0px;">
                                                <a class="dropdown-item" href="{{ route('painel.clinicas.participante.deletar', ['participante' => $participante]) }}" style="color: red"
                                                    href="#">Excluir</a>
                                            </div>
                                        </div>
                                    </td>
