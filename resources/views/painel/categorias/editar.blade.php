                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="nome" name="nome" type="text" class="form-control"
                                        placeholder="Insira o nome" value="{{$contrato->nome}}">
                                </div>
                                <div class="mb-3">
                                        ...
                                        <div
                                            ...
                                            <picture
                                                ...
                                                <img id="banner-preview"
                                                    @if(!$contrato->imagem_mobile) src="{{ asset('admin/images/thumb-padrao.png') }}" @else src="{{asset($contrato->imagem_mobile)}}"  @endif
                                    ...
                                    <div class="row">
                                        <div
                                            ...
                                            <picture
                                                ...
                                                <img id="logo-preview" @if(!$contrato->imagem_desktop) src="{{ asset('admin/images/thumb-padrao.png') }}" @else src="{{asset($contrato->imagem_desktop)}}"  @endif
                                                    style="height: 100%;" alt="">
                                            </picture>
                                        </div>
                                    </div>
