...
@section('titulo')
Catálogo / <a style="color: unset" href="{{ route('painel.expositores') }}">Expositores</a> / Editar
@endsection
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="nome" name="nome" type="text" placeholder="Insira o Nome" class="form-control" maxlength="100" value="{{ $expositor->nome }}">
                            </div>
                            <div class="mb-3">
                                <label for="telefone">Telefone</label>
                                <input class="form-control" name="telefone" type="tel" placeholder="Insira o telefone" id="example-tel-input" maxlength="20" value="{{ $expositor->telefone }}">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="site" type="url" placeholder="Insira a URL" id="example-url-input" maxlength="255" value="{{ $expositor->site }}">
                            </div>
                            <div class="mb-3">
                                <label for="email">E-mail</label>
                                <input class="form-control" name="email" type="email" placeholder="Insira o e-mail" id="example-email-input" maxlength="100" value="{{ $expositor->email }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 text-center d-flex align-items-center justify-content-center  flex-column">
                                ...
                                <picture style="height: 281px; width: 100%; background-color: #f3f4f6;overflow: hidden; display: flex; align-items:center; justify-content: center;">
                                    ...
                                    100%; width: 100%; object-fit: cover;" alt="">
                                </picture>
                            </div>
                        </div>
                        <div class="row mt-3">
