                ...
                <div class="row">
                   <div class="col-sm-6">
                      <div class="mb-3">
                         ...
                         <input id="productname" name="productname" type="text" class="form-control" value="hyp8 tec.">
                      </div>
                      <div class="mb-3">
                         <label for="price">Telefone</label>
                         <input class="form-control" type="tel" value="(35) 9 88000000" id="example-tel-input">
                      </div>
                   </div>
                   <div class="col-sm-6">
                     <div class="mb-3">
                        <label for="manufacturername">Site</label>
                        <input class="form-control" type="url" value="https://hyp8.com.br" id="example-url-input">
                     </div>
                     <div class="mb-3">
                        <label for="manufacturername">E-mail</label>
                        <input class="form-control" type="email" value="contato@hyp8.com"  id="example-email-input">
                     </div>
                   </div>
                </div>
