...
class CreatePagamentoCarneParcelasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pagamento_carne_parcelas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pagamento_carne_parcelas');
    }
}
